...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		}else if(driverController_.onDpadUpPressed()){
			if (wristPosition < 3){
				wristPosition ++;
			}else{
				wristPosition = 3;
			}
		}else if (driverController_.onDpadDownPressed()){
			if (wristPosition > 0){
				wristPosition --;
			}else{
				wristPosition = 0;
		...
		case SCALE:
			...
			break;
		case SCALEBACK:
			int setPointWrist = 0, setPointArm = 0;
			...
			System.out.println("Desired Position: " + wristPosition);
			System.out.println("Desired Wrist Position: " + setPointWrist);
			System.out.println("Desired Arm Position: " + setPointArm);
